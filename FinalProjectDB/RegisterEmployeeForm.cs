    ...
    public partial class RegisterEmployeeForm : core
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "INSERT INTO [transaction] (NIK, TransactionTypeID, NoSurat, EffectiveDate, EndDate, ContractTypeID, BranchID, DepartmentID, PositionID, LevelID, Reasons, Notes) " +
                                    "VALUES (@NIK, @TransactionTypeID, @NoSurat, @EffectiveDate, @EndDate, @ContractTypeID, @BranchID, @DepartmentID, @PositionID, @LevelID, @Reasons, @Notes)";
